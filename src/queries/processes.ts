...
export function useGetProcess(processId: string) {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      const response = await atLicense.processes.get({ id: processId })
...
export function useListProcesses(params?: {
  ...
  const query = useQuery({
    ...
    queryFn: async () => {
      const response = await atLicense.processes.list(
        params
          ? {
...
export function useCreateProcess() {
  ...
  return useMutation<Process, APIError, Schemas.Processes.CreateValues>({
    mutationFn: async (values) => {
      const response = await atLicense.processes.create(values)
...
export function useUpdateProcess(processId: string) {
  ...
  return useMutation<Process, APIError, Schemas.Processes.UpdateValues>({
    mutationFn: async (values) => {
      const getResponse = await atLicense.processes.get({ id: processId })
      ...
      const updateResponse = await atLicense.processes.update({
        id: processId,
        values: changes,
      })
...
export function useRemoveProcess(processId: string) {
  ...
  return useMutation({
    mutationFn: () => atLicense.processes.remove({ id: processId }),
