...
export function useGetUser(userId: string) {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      const response = await atLicense.users.get({ id: userId })
...
export function useListUsers(
  ...
  const query = useQuery({
    ...
    queryFn: async () => {
      const response = await atLicense.users.list(
        params
          ? {
...
export function useCreateUser() {
  ...
  return useMutation<User, APIError, Schemas.Users.CreateValues>({
    mutationFn: async (values) => {
      const response = await atLicense.users.create(values)
...
export function useUpdateUser(userId: string) {
  ...
  return useMutation<User, APIError, Schemas.Users.UpdateValues>({
    mutationFn: async (values) => {
      const getResponse = await atLicense.users.get({ id: userId })
      ...
      const updateResponse = await atLicense.users.update({
        id: userId,
        values: changes,
      })
...
export function useRemoveUser(userId: string) {
  ...
  return useMutation({
    mutationFn: () => atLicense.users.remove({ id: userId }),
...
export function useChangeUserGroup() {
  ...
  >({
    mutationFn: async ({ userId, groupId }) => {
      const response = await atLicense.users.changeGroup({
        id: userId,
        groupId,
      })
...
export function useBanUser(userId: string) {
  ...
  return useMutation<User, APIError>({
    mutationFn: async () => {
      const response = await atLicense.users.ban({ id: userId })
...
export function useUnbanUser(userId: string) {
  ...
  return useMutation<User, APIError>({
    mutationFn: async () => {
      const response = await atLicense.users.unban({ id: userId })
...
export function useChangePassword() {
  ...
  >({
    mutationFn: async ({ oldPassword, newPassword }) => {
      const meResponse = await atLicense.profiles.me()

      if (!meResponse.data) {
        throw new Error("Current user not found")
      }

      const response = await atLicense.users.changePassword({
...
export function useResetPassword() {
  return useMutation<void, APIError, { email: string }>({
    mutationFn: async ({ email }) => {
      const response = await atLicense.users.forgotPassword({ email })
...
export const currentUserQueryOptions = () => ({
  ...
  queryFn: async () => {
    const response = await atLicense.profiles.me()
...
export function useUpdateCurrentUser() {
  ...
  return useMutation<User, APIError, Schemas.Users.UpdateValues>({
    mutationFn: async (values) => {
      const getResponse = await atLicense.profiles.me()
