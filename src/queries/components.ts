...
export function useGetComponent(componentId: string) {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      const response = await atLicense.components.get({ id: componentId })
...
export function useListComponents(params?: {
  ...
  const query = useQuery({
    ...
    queryFn: async () => {
      const response = await atLicense.components.list(
        params
          ? {
...
export function useCreateComponent() {
  ...
  return useMutation<Component, APIError, Schemas.Components.CreateValues>({
    mutationFn: async (values) => {
      const response = await atLicense.components.create(values)
...
export function useUpdateComponent(componentId: string) {
  ...
  return useMutation<Component, APIError, Schemas.Components.UpdateValues>({
    mutationFn: async (values) => {
      const getResponse = await atLicense.components.get({ id: componentId })
      ...
      const updateResponse = await atLicense.components.update({
        id: componentId,
        values: changes,
      })
...
export function useRemoveComponent(componentId: string) {
  ...
  return useMutation({
    mutationFn: () => atLicense.components.remove({ id: componentId }),
